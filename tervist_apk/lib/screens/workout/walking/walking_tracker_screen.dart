      ...
      child: Row(
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 12,
              color: widget.textColor ?? Colors.amber[800],
            ),
          ),
        ],
      ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildWorkoutTypeButton('Walking', true), // This one should be selected for walking screen
  ...
  Widget _buildWorkoutTypeButton(String label, bool isSelected) {
    ...
    return InkWell(
      onTap: () {
        ...
        //   // Navigate to CyclingTrackerScreen
        //   Navigator.of(context).pushReplacement(
        //     MaterialPageRoute(builder: (context) => const CyclingTrackerScreen()),
        //   );
